...
Aidants Connect est un service numérique de l'État porté par l'Agence Nationale de la Cohésion des Territoires ([ANCT](https://agence-cohesion-territoires.gouv.fr/)). Il a été développé selon la méthode « start-up d'Etat » avec l'appui de la [Mission Société Numérique.](https://societenumerique.gouv.fr/fr/)
...
* « Éditeur » se réfère à la Direction interministérielle du numérique ;
* « Service » se réfère à la Plateforme Aidants Connect et à ses fonctionnalités ;
* « Structure » se réfère à la personne morale qui est habilitée Aidants Connect ;
* « Référent Aidant Connect » se réfère à la personne identifiée lors de l'habilitation, qui met en place, assure le suivi du déploiement du dispositif dans la structure et veille à la sécurité du service ;
...
Article 4 - Obtention d'un accès à Aidant Connect pour un Aidant
----------------------------------------------------------------

Pour obtenir un accès au Service, la Structure doit remplir le [formulaire d'habilitation disponible en ligne](https://aidantsconnect.beta.gouv.fr/habilitation/nouvelle/).  
L'équipe Aidants Connect est habilitée pour valider la demande.

Article 5 - Connexion des Aidants au service Aidants Connect
------------------------------------------------------------

Pour se connecter au Service, un Aidant doit renseigner son adresse électronique individuelle, nominative et professionnelle qui a été déclarée au service par la Structure habilitée et utiliser un moyen de connexion pour générer un code à usage unique (une carte physique ou virtuelle). Un courrier électronique contenant un lien de connexion lui sera envoyé pour se connecter à son compte.

Lorsqu'un Aidant est inactif depuis 5 mois, il reçoit un e-mail pour l'avertir que son compte sera désactivé dans un délai de 1 mois à compter de la réception de l'e-mail.
...
### 6.2 Responsabilités du Référent Aidants Connect

Le Référent Aidants Connect s'engage à :
...
Les sources des informations diffusées sur la Plateforme sont réputées fiables mais la Plateforme ne garantit pas qu'il soit exempt de défauts, d'erreurs ou d'omissions.
...
### 7.3 Conclusion d'un mandat à distance
...
Il est obligatoire de remettre à l'Usager la version papier du mandat conclu.
...
Ce service est destiné aux Structures habilitées Aidants Connect et à leurs Aidants professionnels qui accompagnent les Usagers à effectuer leurs démarches administratives en ligne. Le terme « d'Aidant professionnel » désigne ici des personnes ayant un statut professionnel, il peut s'agir notamment de travailleurs sociaux, d'agents publics d'accueil, de médiateurs numériques salariés d'une structure de droit privé.
